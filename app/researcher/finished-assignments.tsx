...
import { assignmentsQuery } from 'pages/researcher/_gql/finished-assignments.gql';
import { PAGE_SIZE } from 'pages/researcher/_data/shared/constants.data';
import { mapAssignments } from 'pages/researcher/_adapters/mappers/finished-assignments.map';
import {
  TAssignment,
...
export default FinsihedAssignments;
